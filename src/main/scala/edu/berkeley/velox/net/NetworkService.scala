...
trait NetworkService {
  ...
  var bytesWrittenCounter = new AtomicLong(0)
  var bytesSentCounter = new AtomicLong(0)
  var bytesRecvCounter = new AtomicLong(0)
  var bytesReadCounter = new AtomicLong(0)
